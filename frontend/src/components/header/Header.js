...
const Header = ({clickLogo}) => {
  return (
    ...
    <div className="container mx-72  text-justify">
        
        <h3 >DevSoc presents</h3>
        <h1 className={`mt-3 justify-center font-bold md:text-7xl text-4xl ${!clickLogo && 'text-unilectives-blue'}`}>
          unilectives.
        </h1>
        <h3 className='mt-3 font-bold'>Your one-stop for UNSW course and elective reviews.</h3>
    </div>
    </>
  )
